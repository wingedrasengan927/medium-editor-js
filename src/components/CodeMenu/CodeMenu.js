...
import { SET_CODE_LANGUAGE_COMMAND, SET_CODE_THEME_COMMAND } from "../../plugins/CodePlugin.js";

const DEFAULT_LANGUAGES = [
  "javascript", "typescript", "html", "css", "json",
  "markdown", "python", "java", "c", "cpp", "rust",
  "go", "sql", "bash", "plaintext"
];

const DEFAULT_THEMES = [
  "github-dark", "github-light", "poimandres", "dracula",
  "one-light", "one-dark-pro", "nord", "min-light", "min-dark"
];
...
export class CodeMenu {
  ...
  #buildDom() {
    ...
    const langDropdown = this.#createDropdown(
      ...
      "Language",
      (val) => {
        this.editor.dispatchCommand(SET_CODE_LANGUAGE_COMMAND, [this.codeNodeKey, val]);
    ...
    const themeDropdown = this.#createDropdown(
      ...
      "Theme",
      (val) => {
        this.editor.dispatchCommand(SET_CODE_THEME_COMMAND, [this.codeNodeKey, val]);
  ...
  #closePopovers() {
    const popovers = this.element.querySelectorAll(".code-menu-popover.open");
